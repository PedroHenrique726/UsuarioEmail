...
public class Usuario {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("++ Dica: Para facilitar a navegação você pode usar apenas a primeira letra da palavra. ++");
			...
			do {
				...
				if (cliente.equals("contatos") || cliente.equals("c") || cliente.equals("contato")) {
					...
					do {
						System.out.println(
								"Digite 'Consultar', 'Adicionar' ou 'Apagar' para fazer alterações nos contatos ou digite 'voltar'");
						cliente = sc.nextLine().toLowerCase();
